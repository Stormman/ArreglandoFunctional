...
public func dismember<A, B>(member: @escaping (A) -> () -> B) -> (A) -> B {
	return { o in member(o)() }
}

public func dismember<A, T, B>(member: @escaping (A) -> (T) -> B) -> (A) -> (T) -> B {
	return { o in { t in member(o)(t) } }
}

public func dismember<A, T, U, B>(member: @escaping (A) -> (T, U) -> B) -> (A) -> (T) ->( U) -> B {
	return { o in { t in { u in member(o)(t, u)} } }
}

public func dismember<A, T, U, V, B>(member:@escaping (A) -> (T, U, V) -> B) -> (A) -> (T) -> (U) ->( V) -> B {
