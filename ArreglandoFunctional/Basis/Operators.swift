...
precedencegroup ternaryMasRight   {
...
precedencegroup ternaryMasLeft   {
...
precedencegroup additiveMasRight   {
...
precedencegroup additiveMasLeft   {
...
///
///		g • f x = g(f(x))
infix operator • :gr //precedence 190
...
infix operator <<< : ternaryMasRight
...
infix operator <+> : additiveMasRight
/*
{
	precedence 150
	associativity right
...
/// Sequence Right | Disregards the Functor on the Left.
infix operator *< : additiveMasLeft
/*
 {
	precedence 140
	associativity left
